...
object stream_processing_app {
  def main(args: Array[String]): Unit = {
    ...
    val mysql_jdbc_url = "jdbc:mysql://" + mysql_host_name + ":" + mysql_port_no + "/" + mysql_database_name +"?serverTimezone=UTC"
    //mongodb+srv://camil:<password>@cluster0-vwgo4.mongodb.net/<dbname>?retryWrites=true&w=majority
